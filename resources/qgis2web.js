...
map.getView().fit([12538261.727296, -820599.859540, 12562485.462443, -807894.804260], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGis Kampus Negeri Surabaya</h2>';
        return titleElement;
    })(),
